...
db = create_engine("postgresql://postgres:tiger@localhost/chinook")
...
# crteating records on out Programmer table. 
...
# session.add(ruairidh_macarthur)
...
# programmer.first_name = "Tim",
# programmer.last_name = "N",
# programmer.gender = "M",
# programmer.nationality = "American",
# programmer.famous_for = "CI Tutor",
